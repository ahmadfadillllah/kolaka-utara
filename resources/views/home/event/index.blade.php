    ...
    <div
        ...
        <div class="flex flex-wrap mx-[-15px]">
            <div class="xl:w-8/12 lg:w-8/12 w-full flex-[0_0_auto] px-[15px] max-w-full !mx-auto">
                <h1 class="text-[calc(1.365rem_+_1.38vw)] font-bold leading-[1.2] xl:text-[2.4rem] mb-3 text-white">Event</h1>
        ...
        <div class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px]">
                ...
                <div class="blog itemgrid grid-view">
                    <div class="flex flex-wrap mx-[-15px] isotope xl:mx-[-20px] lg:mx-[-20px] md:mx-[-20px] mt-[-40px] !mb-8">
                        ...
                        <article class="item post xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] xl:px-[20px] lg:px-[20px] md:px-[20px] mt-[40px] px-[15px] max-w-full">
                            <div class="card">
                                <figure class="card-img-top overlay overlay-1 hover-scale group"><a href="{{ route('home.event.show', $ev->uuid) }}">
                                ...
                                <div
                                    ...
                                    <div class="post-header !mb-[.9rem]">
                                        ...
                                        <h2 class="post-title h3 !mt-1 !mb-3"><a
                                                ...
                                                href='{{ route('home.event.show', $ev->uuid) }}'>{{ $ev->judul }}</a></h2>
                                    </div>
                                    <!-- /.post-header -->
                                    <div class="!relative">
                                ...
                                <div
                                    ...
                                    <ul class="text-[0.7rem] text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                                        <li class="post-date inline-block"><i
                                                class="uil uil-calendar-alt pr-[0.2rem] align-[-.05rem] before:content-['\e9ba']"></i><span>{{ \Carbon\Carbon::parse($ev->created_at)->format('d M Y') }}</span></li>
                                        <li
            ...
            <aside
                ...
                <div class="widget mt-[40px]">
                    ...
                    <p>Event Kolaka Utara adalah acara yang diselenggarakan untuk mempromosikan wisata, seni, dan budaya daerah Kolaka Utara, Sulawesi Tenggara. Acara ini biasanya melibatkan pertunjukan seni dan pameran produk lokal</p>
                ...
                <div class="widget mt-[40px]">
                    ...
                    <ul class="pl-0 list-none bullet-primary !text-inherit">
                        ...
                        <li class="relative pl-[1rem] before:absolute  before:top-[-0.15rem] before:text-[1rem] before:content-['\2022'] before:left-0 before:font-SansSerif">
                            <a class="text-inherit hover:text-[#3f78e0]" href="{{ url()->current() }}?kategori={{ $kat->nama_kategori }}">{{ $kat->nama_kategori }} ({{ $kat->event_count }})</a>
                        </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="widget mt-[40px]">
                    ...
                    <ul class="pl-0 list-none tag-list">
                        ...
                        <li class=" mt-0 mb-[0.45rem] mr-[0.2rem] inline-block">
                            <a href="{{ url()->current() }}?tags={{ $tags->nama }}" class="btn btn-soft-ash btn-sm !rounded-[50rem] flex items-center hover:translate-y-[-0.15rem] hover:shadow-[0_0.25rem_0.75rem_rgba(30,34,40,.05)] before:not-italic before:content-['#'] before:font-normal before:pr-[0.2rem]">
                                {{ $tags->nama }}
                            </a>
                        </li>
                        @endforeach
